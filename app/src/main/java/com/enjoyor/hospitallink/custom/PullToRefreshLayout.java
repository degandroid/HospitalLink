...
import com.enjoyor.hospitallink.protocol.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private int loading_pic;
    private int refresh_pic;

    public void setLoading(String loading) {
        this.loading = loading;
    }

    public void setRefreshPic(int refresh_pic) {
        this.refresh_pic = refresh_pic;
    }
    public void setLoadingPic(int loading_pic) {
...
//		 添加匀速转动动画
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView
                        .setBackgroundResource(loading_pic);
                break;
            case FAIL:
            default:
                // 刷新失败
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(loading_pic);
                break;
            case FAIL:
            default:
                // 加载失败
    ...
    private void initView() {
        ...
        ((ImageView) pullView).setImageResource(refresh_pic);
        ...
        ((ImageView) loadingView).setImageResource(loading_pic);
