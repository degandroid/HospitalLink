...
//        else if(state == STATE_CUSTOME){
//            mHintView.setVisibility(View.VISIBLE);
//            mHintView.setText(R.string.xlistview_footer_hint_hosptalline);
//            Drawable nav_up=getResources().getDrawable(R.mipmap.hl_icon_load);
//            nav_up.setBounds(0, 0, nav_up.getMinimumWidth(), nav_up.getMinimumHeight());
//            mHintView.setCompoundDrawables(nav_up, null,null , null);
//        }
        else{
            mHintView.setVisibility(View.VISIBLE);
            mHintView.setText(R.string.xlistview_footer_hint_hosptalline);
