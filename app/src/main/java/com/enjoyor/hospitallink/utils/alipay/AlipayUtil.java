package com.enjoyor.hospitallink.utils.alipay;
...
/**
 * Created by jinshaoling on 16/1/19.
 */
public class AlipayUtil {
    ...
    private Context mContexn;

    public AlipayUtil(Activity mActivity, Handler mHandler) {
        this.mActivity = mActivity;
        this.mHandler = mHandler;
        this.mContexn = mActivity;
    }

    public boolean startAlipay(String payInfo) {
    ...
    public void toPay(String payInfo) {
